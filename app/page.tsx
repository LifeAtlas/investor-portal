...
const stats = [
  ...
  { label: "Framework", value: "WHO QoL + M4" },
];
...
const timelinePhases = [
  {
    ...
    desc: "Your genome, epigenome, microbiome, wearable streams, and life data — unified in one edge-native OS. M4 mechanistic models simulate your biology before you act. The first user becomes the proof that a life can be quantified, predicted, and optimized.",
    color: "blue",
  },
  {
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 pt-16 pb-20 relative">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-[var(--color-text-secondary)] text-sm tracking-widest uppercase">Investor Portal v2</span>
          </div>

          <h1 className="text-5xl md:text-6xl font-bold leading-tight mb-6 tracking-tight">
            The Last Platform.<br />
      ...
      {/* ═══ Convergence — What Exists vs What We Build ═══ */}
      <section className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl p-8">
          <div className="grid md:grid-cols-5 gap-4 items-center text-center">
            <div className="bg-blue-950/30 border border-blue-800/30 rounded-xl p-4">
              ...
              <div className="font-semibold text-blue-400 text-sm">Your M4 Twin</div>
          ...
          <div className="mt-6 text-center">
            <div className="inline-block bg-gradient-to-r from-blue-950/30 via-green-950/30 to-emerald-950/30 border border-green-800/20 rounded-xl px-6 py-3">
              <p className="text-sm text-[var(--color-text-secondary)]">
                ...
                "Given your current MTHFR methylation state and declining B12 trajectory,
                grow this specific cultivar under adjusted light spectrum and nutrient delivery
                to maximize bioavailable folate and methylcobalamin precursors."
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        ...
        <p className="text-[var(--color-text-secondary)] mb-8 max-w-3xl">
          ...
          Every component replaceable. No vendor lock-in. All MIT/Apache 2.0.
        </p>
        <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-xl p-6 font-mono text-sm leading-loose">
          <div className="text-[var(--color-text-secondary)]">
            ...
            {"    → "}<span className="text-[var(--color-text)]">Orchestration</span> (31 AI agents, MAGS loop, NeMo Guardrails)<br />
            {"      → "}<span className="text-[var(--color-text)]">M4 Mechanistic Models</span> (human biology simulation)<br />
            {"      → "}<span className="text-[var(--color-text)]">Plant Growth Models</span> (cultivar genome, environment params)<br />
            {"        → "}<span className="text-[var(--color-text)]">Data Fabric</span> (Supabase + Neo4j + Qdrant + EdgeLake + SQLite)<br />
