...
const chapters: Chapter[] = [
  {
    ...
    paragraphs: [
      ...
      "The mechanistic model was running in the background — a simulation of his own biology, calibrated against his wearable data, his SNPs, his methylation profile. Years of mechanistic-modelling research, repurposed from pharmaceutical science into something nobody had quite imagined: a digital twin of a living person that didn't just mirror — it predicted.",
